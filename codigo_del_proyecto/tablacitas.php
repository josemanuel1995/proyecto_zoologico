...
<table class="table table-bordered table-hover table-condensed" border="6">
	...
	<thead>
	<tr>
	<th colspan="1" class="active success"><a href="forcitas.html"> Nuevo</a> 
	<th colspan="10" class="active success"><center>Lista De citas </th></center>
	</tr>
	...
	<td>fecha_cita</td>
	<td>hora_cita</td>
	<td>encargado_del_animal</td>
	<td>nombre_veterinario</td>
	...
	<td><?php echo $row['razon_citas'];?></td>
	<td><?php echo $row['tipo_cita'];?></td>
	<td><?php echo $row['fecha_cita'];?></td>
	<td><?php echo $row['hora_cita'];?></td>
	<td><?php echo $row['encargado_del_animal'];?></td>
	<td><?php echo $row['nombre_veterinario'];?></td>
	<td><a href="modificarcitas.php?id=<?php echo $row['id'];?>"><img src="editar.png" class="img-responsive" align="center"></a></td>
	<td><a href="eliminarcitas.php?id=<?php echo $row['id'];?>"><img src="eliminar.png" class="img-responsive" align="center"></a></td>
	</tr>
	<?php
	}
	?>
