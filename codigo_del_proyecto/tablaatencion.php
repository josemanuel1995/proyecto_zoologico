...
<table class="table table-bordered table-hover table-condensed" border="6">
	...
	<thead>
	<tr>
	<th colspan="1" class="active success"><a href="foratencion.html"> Nuevo</a> 
	<th colspan="10" class="active success"><center>Atencion de Citas </th></center>
	</tr>
	...
	<td><?php echo $row['tratamientos'];?></td>
	<td><a href="modificaratencion.php?id=<?php echo $row['id'];?>"><img src="editar.png" class="img-responsive" align="center"></a></td>
	</tr>
	<?php
	}
	?>
