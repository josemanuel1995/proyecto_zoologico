...
<table class="table table-bordered table-hover table-condensed">
	...
	<th colspan="9" class="active success"><center>lista de solicitudes de plan </th></center>
	</tr>
	...
	$query="SELECT *FROM solicitudplan";
	...
	<td><a href="modificarplan.php?id=<?php echo $row['id'];?>"><img src="editar.png" class="img-responsive" align="center"></a></td>
	<td><a href="eliminarplan.php?id=<?php echo $row['id'];?>"><img src="eliminar.png" class="img-responsive" align="center"></a></td>
	</tr>
	<?php
	}
	?>
