...
<table class="table table-bordered table-hover table-condensed" border="6">
	...
	<thead>
	<tr>
	<th colspan="1" class="active success"><a href="forparqueo.html"> Nuevo</a> 
	<th colspan="10" class="active success"><center>Lista De Parqueadero </th></center>
	</tr>
	...
	<td><?php echo $row['pagara'];?></td>

	<td><a href="modificarparque.php?id=<?php echo $row['id'];?>"><img src="editar.png" class="img-responsive" align="center"></a></td>
	<td><a href="eliminarparque.php?id=<?php echo $row['id'];?>"><img src="eliminar.png" class="img-responsive" align="center"></a></td>
	</tr>
	<?php
	}
	?>
