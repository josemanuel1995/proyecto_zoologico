...
<form action="modificar_pro.php?id=<?php echo $row['id'];?>" method="POST">
  ...
  <input type="text" class="form-control" value="<?php echo $row['nombre'];?>" name="nombre"  required /></div>
			 ...
			 <div class="form-group">
              ...
              <input type="text" class="form-control" value="<?php echo $row['telefono'];?>" name="telefono"  required></div>
			  
			   <div class="form-group">
				<label class="control-label">Horas de trabajo</label>
              <input type="text" name="horas" class="form-control" required>
			  </div>
			  
			  <div class="form-group">
				<label class="control-label">dias de trabajo</label>
