...
<table class="table table-bordered table-hover table-condensed">
	...
	<thead>
	<tr>
	<th colspan="1" class="active success"><a href="forpersonal.html"> Nuevo Registro</a> 
	<th colspan="10" class="active success"><center>Lista De personal </th></center>
	</tr>
	...
	<td><a href="modificarpersonal.php?id=<?php echo $row['id'];?>"><img src="editar.png" class="img-responsive" align="center"></a></td>
	<td><a href="eliminarpersonal.php?id=<?php echo $row['id'];?>"><img src="eliminar.png" class="img-responsive" align="center"></a></td>
	</tr>
	<?php
	}
	?>
