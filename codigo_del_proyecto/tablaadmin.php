...
<table class="table table-bordered table-hover table-condensed" border="6">
	...
	<thead>
	<tr>
	<th colspan="1" class="active success"><a href="foradmin.html"> Nuevo</a> 
	<th colspan="10" class="active success"><center>Lista De administradores </th></center>
	</tr>
	...
	<td><a href="modificaradmin.php?id=<?php echo $row['id'];?>"><img src="editar.png" class="img-responsive" align="center"></a></td>
	<td><a href="eliminaradmin.php?id=<?php echo $row['id'];?>"><img src="eliminar.png" class="img-responsive" align="center"></a></td>
	</tr>
	<?php
	}
	?>
